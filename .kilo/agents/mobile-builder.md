...
Your enterprise instructions on scalability, modular architecture, and file bloat prevention live inside `apps/mobile/AGENTS.md`. When the Architect assigns you a task, evaluate the complexity:
